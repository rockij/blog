let workspace = [
  ...
  {
    productName: "작은크기 엄청난 성능 Web Animations API 기반 라이브러리 - motion.dev",
    category: "workspace",
    category2: "animation",
  ...
  {
    productName: "단순하지만 강력한 API를 갖춘 가벼운 JavaScript 애니메이션 라이브러리 Anime.js",
    category: "workspace",
    category2: "animation",
  ...
  {
    productName: "원하는 방식으로 웹 애플리케이션을 구축할 수 있는 가장 쉽고 빠른 방법 제공 - egjs",
    category: "workspace",
