let items = [
  ...
  },
  {
    ...
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/circle_mov_animation.html',
  },
  {
    productName: 'star - CSS를 사용한 분수 SVG 별',
    category: 'icon-loading',
    url: 'icon-loading/fractional_SVG_stars.html',
  },
  {
    productName: '3D - 아이소메트릭 큐브',
    category: 'icon-loading',
    url: 'icon-loading/isometric_cube.html',
  },
  {
    productName: 'icon-loading/rotating_border_animation.html',
    category: 'background-border',
    category2: 'animation',
    url: 'rotate - 박스 주변 테두리로 라인회전 animation',
  },
  {
    productName: '뾰족한 그림자가 양끝에 나와있는 카드',
    category: 'background-border',
    url: 'icon-loading/creative_website_card_effects.html',
  },
  {
    productName: 'cartoon - css만 이용해 물방울 모양 그리기',
    category: 'icon-loading',
    url: 'icon-loading/water_drops_drawing.html',
  },
  {
    productName: 'flower - 색종이 떨어지는 애니메이션',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/confetti_fallling.html',
  },
  {
    productName: 'line - SVG그리기 애니메이션',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/svg_stroke_animation.html',
  },
  {
    productName: 'wifi animation',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/wifi_loading_animation.html',
  },
  {
    productName: 'loading 문구 순차적 wave',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/wavy_text_animation.html',
  },
  {
    productName: 'shadow - flat long box shadow(js)',
    category: 'background-border',
    url: 'icon-loading/text-flat_long_box_shadow_vanilla.html',
  },
  {
    productName: 'bounce - 힘없이 공이 떨어지는',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/bounce_animation.html',
  },
  {
    productName: 'bounce - 공이 통통 튀는',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/bouncing_ball.html',
  },
  {
    productName: 'bubble - background 비눗방울 전체 날림',
    category: 'background-border',
    category2: 'animation',
    url: 'icon-loading/bubble_animation_background.html',
  },
  {
    productName: 'loading - 원2개가 겹친 상태에서 크게 작게',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/cool_css_loading_animation.html',
  },
  {
    productName: 'mouse - 3가지 형태의 스크롤 유도모션',
    category: 'icon-loading',
    url: 'icon-loading/cool_scroll_icon_animation.html',
  },
  {
    productName: 'loading - 서서히 퍼지면서 알람',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/css_pulse_animation.html',
  },
  {
    productName: '전체화면 게이지 채우면서 100',
    category: 'text-effect',
    category2: 'icon-loading',
    url: 'icon-loading/full_screen_pre-loader_using.html',
  },
  {
    productName: '좌상단을 꼭지점으로 매달리다 떨이지는',
    category: 'text-effect',
    category2: 'animation',
    url: 'icon-loading/hinge_animation.html',
  },
  {
    productName: 'cartoon - 모래시계',
    category: 'icon-loading',
    url: 'icon-loading/hourglass-drawing_width_css_vanilla.html',
  },
  {
    productName: 'icon - 물방울',
    category: 'icon-loading',
    url: 'icon-loading/howtodraw_drop_css.html',
  },
  {
    productName: 'icon - 라운드가 있는 하트',
    category: 'icon-loading',
    url: 'icon-loading/howtodraw_heart_css2.html',
  },
  {
    productName: 'icon - 일반적인 하트',
    category: 'icon-loading',
    url: 'icon-loading/howtodraw_heart_css.html',
  },
  {
    productName: 'fireworks - 축하 꽃가루',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/simple_stick_fireworks.html',
  },
  {
    productName: 'loading - 배터리 채워지는',
    category: 'icon-loading',
    category2: 'animation',
    url: 'icon-loading/single_element_battery_animation.html',
  },
  {
    productName: 'checkbox - v checked style animated3',
    category: 'form',
    category2: 'animation',
    url: 'form/material_ui_style_animated_checkboxes4.html',
  },
  {
    productName: 'validation - 패턴으로 검증(only-css)',
    category: 'form',
    url: 'form/validation_with_patterns.html',
  },
  {
    productName: 'clock - selectbox를 활용한 간단한 알람시계 구축(js)',
    category: 'form',
    url: 'form/alarm_clock/index.html',
  },
  {
    productName: 'calendar - 순수 자바스크립트로 만든 달력',
    category: 'calendar',
    url: 'form/full_calendar_javaScript.html',
  },
  {
    productName: '입력 필드를 누를 때 입력 필드 텍스트 선택',
    category: 'form',
    url: 'form/select_all_text_input_clicked.html',
  },
  {
    productName: 'Copy - 입력 요소에서 클립보드로 복사',
    category: 'form',
    url: 'form/copy_clipboard_input_element.html',
  },
  {
    productName: 'upload - 업로드하기 전에 여러 이미지 미리 보기',
    category: 'form',
    url: 'form/rpeview_multiple_images_before_upload.html',
  },
  {
    productName: '두 날짜 사이의 일 계산기',
    category: 'form',
    url: 'form/days_between_two_dates_calculator.html',
  },
  {
    productName: 'select - 사용자 지정 선택 메뉴',
    category: 'form',
    category2: 'navigation-list',
    url: 'form/select_custom_menu.html',
  },
  {
    productName: 'checkbox - v checked style animated2',
    category: 'form',
    category2: 'animation',
    url: 'form/material_ui_style_animated_checkboxes2.html',
  },
  {
    productName: 'input - HTML CSS & JavaScript로 사전 앱 구축 close버튼',
    category: 'form',
    url: 'form/build_dictionary_app.html',
  },
  {
    productName: 'select - 멋진 드롭다운 목록 상호 작용',
    category: 'form',
    category2: 'animation',
    url: 'form/awesome_dropdown_list_interaction.html',
  },
  {
    productName: 'slider - 최소값 범위 슬라이더(H 단위) 입력값',
    category: 'form',
    url: 'form/price_range_slider_min-max_input.html',
  },
  {
    productName: 'input - 태그 추가 입력 상자',
    category: 'form',
    url: 'form/add_tags_input_box.html',
  },
  {
    productName: 'slider - heart 색 채우기 슬라이더',
    category: 'form',
    url: 'form/heart_range_slider.html',
  },
  {
    productName: '입력시 Caps Lock 감지',
    category: 'form',
    url: 'form/how_to_detect_caps_lock_on.html',
  },
  {
    productName: 'input - 검색된 텍스트 강조',
    category: 'form',
    url: 'form/highlight_searched_text.html',
  },
  {
    productName: '+ or - 선택 스테퍼',
    category: 'form',
    url: 'form/input_stepper.html',
  },
  {
    productName: 'input - 현재 입력 암호 재입력 확인',
    category: 'form',
    url: 'form/confirm_password_validation.html',
  },
  {
    productName: 'checkbox - 이모지 별점 위젯(only css)',
    category: 'form',
    url: 'form/emoji_star_rating_widget.html',
  },
  {
    productName: 'slider - 맞춤형 이모지 범위 슬라이더',
    category: 'form',
    url: 'form/custom_emoji_range_slider.html',
  },
  {
    productName: 'input - 입력 문자수 체크 제한',
    category: 'form',
    url: 'form/limit_Input_characters_javaScript.html',
  },
  {
    productName: 'input - 이메일 유효성 검사',
    category: 'form',
    url: 'form/check_email_validation_javascript.html',
  },
  {
    productName: 'slider - 멀티 핸들 레인지 슬라이더',
    category: 'form',
    url: 'form/multi_handle_range_slider.html',
  },
  {
    productName: 'input - 비밀번호 공개 입력 옵션',
    category: 'form',
    url: 'form/options_password_revealing_inputs.html',
  },
  {
    productName: 'checkbox - box-shadow을 이용한 체크박스 animation',
    category: 'form',
    category2: 'animation',
    url: 'form/checkbox_box-shadow.html',
  },
  {
    productName: 'checkbox - 경계 반경 변경하는 체크박스',
    category: 'form',
    category2: 'animation',
    url: 'form/checkbox_border-radius.html',
  },
  {
    productName: 'checkbox - box 3D 회전하는 체크박스',
    category: 'form',
    category2: 'animation',
    url: 'form/checkbox_3d_rotation.html',
  },
  {
    productName: 'form/No-JS_typing_suggestions.html',
    category: 'form',
    url: 'input - js필요할거 같지만 필요없는 입력요소(only pc)',
  },
  {
    productName: 'input - 검색입력 Google 검색 엔진 적용',
    category: 'form',
    url: 'form/google_search_engine.html',
  },
  {
    productName: 'checkbox - 체크박스 전체선택 여부 확인',
    category: 'form',
    url: 'form/checkbox_selectchecked.html',
  },
  {
    productName: 'input - 돋보기 hover 입력할 수 있도록 커짐',
    category: 'form',
    category2: 'animation',
    url: 'form/morphing_form_search_icon_to_search_bar.html',
  },
  {
    productName: 'textarea - 쓰는 글의 크기만큼 자동 리사이징',
    category: 'form',
    url: 'form/live_character_count_es6.html',
  },
  {
    productName: 'input - placeholder focus 입력박스 바깥으로 움직임',
    category: 'form',
    category2: 'animation',
    url: 'form/animated_input_label_using.html',
  },
  {
    productName: 'input - 돋보기 hover 검색 입력박스 확장 움직임',
    category: 'form',
    category2: 'animation',
    url: 'form/awesome_css_search_box_html_css.html',
  },
  {
    productName: 'checkbox - omlet switch checkbox animate',
    category: 'form',
    category2: 'animation',
    url: 'form/custom_omlet_switch_checkbox.html',
  },
  {
    productName: 'checkbox - X -> V animate',
    category: 'form',
    category2: 'animation',
    url: 'form/custome_toggle_animated.html',
  },
  {
    productName: 'input - file-upload drag drop 미리보기',
    category: 'form',
    url: 'form/file-upload_drag_drop_browse.html',
  },
  {
    productName: 'input - glassmorphism form design',
    category: 'form',
    category2: 'background-border',
    url: 'form/form-glassmorphism.html',
  },
  {
    productName: 'input - 입력박스 안 값 복사',
    category: 'form',
    url: 'form/form-input_copy.html',
  },
  {
    productName: 'input - 입력박스 값 리스트 형태로 추가&삭제',
    category: 'form',
    url: 'form/list-to_do_list_js.html',
  },
  {
    productName: 'input - 입력시 미리 지정한 값에 맞는 단어 자동 완성',
    category: 'form',
    url: 'form/search_bar_auto-complete_suggestions_js.html',
  },
  {
    productName: 'input - 비밀번호 입력값 보기 끄기, 입력란 배경색 바뀌는 animate',
    category: 'form',
    category2: 'animate',
    url: 'form/show_hide_password_stunning_transitions_js.html',
  },
  {
